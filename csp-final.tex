...
Semeru使得Spark和Flink在资源分解系统上获得了较大的性能提升，端到端性能在CPU服务器cache大小是50\%、25\%的heap大小的情况下分别提升了2.1倍、3.7倍，应用性能提升1.9倍、3.3倍，GC性能提升4.2倍、5.6倍。
...
\begin{table}
  ...
  \begin{tabular}{c|cccccccc}
    ...
    \hline
		% \rule{0pt}{10pt}
    runtime间协调 & \ding{55} & \ding{55} & \ding{51} & \ding{55} & \ding{55} & \ding{55} & \ding{55} &\ding{55} \\
    \hline
		% \rule{0pt}{10pt}
    资源分解架构GC & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} &\ding{51} \\
    \hline
		% \rule{0pt}{10pt}
